...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_NEOKDEMAND)
extern struct cpufreq_governor cpufreq_gov_neokdemand;
#define CPUFREQ_DEFAULT_GOVERNOR (&cpufreq_gov_neokdemand)
#endif
